# taiesm_dev
The `taiesm_dev` repository is dedicated to the ongoing development of the Taiwan Earth System Model (TaiESM) and includes tracking and discussion of -
...
## Discussions 
Relevant discussions about TaiESM development should be posted under the [Discussions](https://github.com/rceclccr/taiesm_dev/discussions) section.
...
## Projects
Tracking current TaiESM coupled model development tasks/issues is found under the [Projects](https://github.com/rceclccr/taiesm_dev/projects) section.
...
- Our [Code of Conduct](https://github.com/rceclccr/taiesm_dev/blob/main/CODE_OF_CONDUCT.md) outlines our expectations for behavior and principles.
